...
function PLEX() {
	...
	this.X_Plex_Product = "Plex Web";
	this.X_Plex_Device= "Mac";
	this.X_Plex_Platform = "Chrome";
	this.X_Plex_Platform_Version = "34.0";
	this.X_Plex_Version = "2.1.12";
	this.X_Plex_Device_Name = "Plex Web (Chrome)";
...
PLEX.prototype.getTimeline = function(key, state, time, duration, guid) {
	$.ajax({
		type: "GET",		
		url: this.getServerUrl() + "/:/timeline?time=" + time + "&duration=" + duration + "&state=" + state + "&key=%2Flibrary%2Fmetadata%2F" + key + "&ratingKey=" + key + "&containerKey=%2Flibrary%2Fmetadata%2F" + key + "&guid=" + guid,
